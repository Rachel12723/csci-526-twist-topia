...
public class PropManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            int buttonIndex = i; // 创建一个局部变量来保存按钮索引
